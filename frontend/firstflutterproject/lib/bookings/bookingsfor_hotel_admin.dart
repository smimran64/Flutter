...
class BookingsByHotelPage extends StatefulWidget {
  const BookingsByHotelPage({Key? key}) : super(key: key);

  @override
  State<BookingsByHotelPage> createState() => _BookingsByHotelPageState();
}

class _BookingsByHotelPageState extends State<BookingsByHotelPage> {
