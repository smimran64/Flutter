...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        boolean skip = path.equals("/api/user/login")|| path.equals("/api/login") || path.equals("/images") || path.startsWith("/images/") || path.startsWith("/api/user/active/") || path.startsWith("/auth/login");
